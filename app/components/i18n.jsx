    ...
    en: {
      translation: {
        ...
        aiImage: {
          ...
          description:
            " A full-stack web application that allows users to create and download images generated by AI. Technology Stack used are Nextjs with TypeScript, React for frotend, Convex for backend, TailwindCss(shadcn, mui), Clerk for authentication, Convex for Database, Stipe for payment and Amazon S3 for file storage.",
    ...
    it: {
      translation: {
        ...
        aiImage: {
          ...
          description:
            "Un'applicazione web full-stack che consente agli utenti di creare e scaricare immagini generate dall'AI. Lo stack tecnologico utilizzato include Nextjs con TypeScript, React per il frontend, Convex per il backend, TailwindCss (shadcn, mui), Clerk per l'authenticazione, Convex per Database, Stripe per i pagamenti e Amazon S3 per l'archiviazione dei file.",
